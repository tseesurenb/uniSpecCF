'''
Enhanced Argument Parser with SVD Support
'''
...
def parse_args():
    parser = argparse.ArgumentParser(description="SVD-Enhanced Simple Universal Spectral CF")
    ...
    parser.add_argument('--n_svd', type=int, default=256, help='number of SVD components')
    ...
    parser.add_argument('--use_svd', action='store_true', 
                       help='enable SVD component (similar to GF-CF)')
    parser.add_argument('--svd_weight', type=float, default=0.3, 
                       help='initial weight for SVD component in combination')
